<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5.aspx.cs" Inherits="kidslearningsystem.com._5" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button2" runat="server" CssClass="newStyle2" Height="145px" OnClick="Button2_Click" Text="5" Width="145px" />
