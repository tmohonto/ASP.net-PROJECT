<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="9.aspx.cs" Inherits="kidslearningsystem.com._9" %>
...
<body>
    ...
    <div>
        ...
        <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/image/stick.jpg" />
        <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/image/stick.jpg" />
        <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/image/stick.jpg" />
        <asp:Button ID="Button1" runat="server" CssClass="newStyle1" Height="145px" Text="=" Width="145px" />
        <asp:Button ID="Button2" runat="server" CssClass="newStyle2" Height="145px" OnClick="Button2_Click" Text="9" Width="145px" />
